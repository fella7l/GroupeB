...
st.sidebar.markdown("""
Embark on a data exploration adventure with our Streamlit app! Featuring a robust DataFrame comprising 112,036 entries and 18 columns, this app is your gateway to uncovering intricate details about customer behavior, product categories, and financial metrics.
""")
...
st.subheader("Customer_Informations")
